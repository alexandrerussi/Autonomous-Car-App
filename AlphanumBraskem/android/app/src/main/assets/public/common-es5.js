...
var Place = /** @class */ (function () {
    function Place(id, title, description, imageUrl, price) {
        this.id = id;
        this.title = title;
...
var PlacesService = /** @class */ (function () {
    function PlacesService() {
        this._places = [
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p1', 'PV-14 Braskem', 'R. Benzeno, 1065, Camaçari - BA', 'https://i.imgur.com/CxCtAzL.png', 149.99),
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p2', 'PE3 Braskem', 'R. Benzeno, 1065, Camaçari - BA', 'https://i.imgur.com/TKRqOwu.png', 149.99),
            new _place_model__WEBPACK_IMPORTED_MODULE_2__["Place"]('p3', 'PV5 - Braskem', 'R. Benzeno, 2391 - Polo de Camaçari, Camaçari - BA, 42810-020', 'https://i.imgur.com/SBLZ0cd.png', 149.99)
        ];
    }
