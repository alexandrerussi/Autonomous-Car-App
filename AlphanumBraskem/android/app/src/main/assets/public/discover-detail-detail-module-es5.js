...
var DetailPage = /** @class */ (function () {
    function DetailPage(router, navCtrl, db) {
        this.router = router;
    ...
    DetailPage.prototype.onBookPlace = function () {
        // this.router.navigateByUrl('/places/tabs/discover');
        // this.navCtrl.navigateBack('/places/tabs/discover');
        // this.navCtrl.pop(); nao tem garantia
        var itemRef = this.db.object(this.PATH);
...
//# sourceMappingURL=discover-detail-detail-module-es5.js.map